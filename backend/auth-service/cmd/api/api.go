...
import (
	...
	"github.com/edwardsean/codesmart/backend/auth-service/service/repository"
...
func (s *APIServer) Run() error {
	...
	repositoryHandler := repository.NewHandler(repositoryStore, userStore)

	repositoryHandler.RegisterRoutes(subrouter)
